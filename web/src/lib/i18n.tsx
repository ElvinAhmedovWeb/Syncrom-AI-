...
const azCore = {
  ...
  "composer.hint": "Syncrom AI — Groq & Puter texnologiyası ilə",
  ...
  "about.techValue": "Groq (LLM), Puter (səs), Firebase (hesab)",
  "about.models": "Modellər",
  "about.close": "Bağla",

  // ---------- Artefakt (canlı önizləmə) ----------
  "key.title": "API açarları",
  "key.sub": "Syncrom AI-ı öz proqramından çağırmaq üçün açar yarat.",
  "key.create": "Yarat",
  "key.creating": "Yaradılır...",
  "key.namePlaceholder": "Açarın adı (məs. Mobil tətbiq)",
  "key.empty": "Hələ açar yaratmamısan.",
  "key.onceWarning": "Bu açar YALNIZ İNDİ göstərilir. Kopyala və təhlükəsiz saxla — bir daha göstərilə bilməz.",
  "key.howTo": "Necə istifadə olunur?",
  "key.forget": "Yerli qeyddən sil",
  "key.needAccount": "Açar yaratmaq üçün hesaba daxil ol.",
  "key.failed": "Açar yaradıla bilmədi. Yenidən cəhd et.",
  "key.revokeNote": "Açar müddəti bitənə qədər işləyir. Vaxtından əvvəl ləğv etmək üçün serverdə SYNCROM_API_SECRET dəyişdirilməlidir — bu, bütün açarları etibarsız edir.",
  "libra.name": "Libra",
  "libra.sub": "İki fərqli model müstəqil cavab verir, sonra çəkilir",
  "libra.agreement": "Razılıq",
  "libra.conflict": "Fərq — bura diqqət",
  "libra.verdict": "Yekun",
  "libra.degraded": "Çəkmə alınmadı, yalnız bir modelin cavabı göstərilir.",
  "libra.failed": "Libra cavab ala bilmədi. Bir az sonra yenidən cəhd et.",
  "status.weighing": "İki model çəkilir...",
  "virgo.name": "Virgo",
  "virgo.hint": "Virgo ilə yoxla — rəqəmləri və faktları ikinci dəfə audit edir",
  "virgo.checking": "Yoxlanılır",
  "virgo.clean": "Problem tapılmadı",
  "virgo.issues": "Problem tapıldı",
  "virgo.apply": "Düzəlişi tətbiq et",
  "virgo.failed": "Audit alınmadı. Bir az sonra yenidən cəhd et.",
  "cap.title": "Capricorn",
  "cap.none": "Layihəsiz",
  "cap.new": "Yeni layihə",
  "cap.newName": "Adsız layihə",
  "cap.edit": "Layihəni redaktə et",
  "cap.sub": "Layihənin məqsədi, təlimatı və bilik bazası bu layihədəki HƏR mesajda modelə ötürülür.",
  "cap.name": "Ad",
  "cap.goal": "Məqsəd",
  "cap.goalHint": "Nəyə çalışırıq? Bir-iki cümlə.",
  "cap.instructions": "Təlimat",
  "cap.instructionsHint": "Model bu layihədə necə davransın? Məs: cavablar qısa olsun, terminləri azərbaycanca yaz.",
  "cap.knowledge": "Bilik bazası",
  "cap.knowledgeHint": "Sabit arxa məlumat: faktlar, terminlər, qaydalar, çıxarışlar. Model buna ümumi biliyindən çox etibar edir.",
  "cap.save": "Yadda saxla",
  "cap.cancel": "Ləğv et",
  "cap.delete": "Layihəni sil",
  "cap.deleteConfirm": "Əminsən? Bir daha bas",
  "cap.deleteNote": "Layihə silinəndə söhbətlər silinmir — sadəcə layihədən ayrılır.",
...
const enCore = {
  ...
  "composer.hint": "Syncrom AI — powered by Groq & Puter",
  ...
  "about.techValue": "Groq (LLM), Puter (voice), Firebase (accounts)",
  "about.models": "Models",
  "about.close": "Close",

  "key.title": "API keys",
  "key.sub": "Create a key to call Syncrom AI from your own software.",
  "key.create": "Create",
  "key.creating": "Creating...",
  "key.namePlaceholder": "Key name (e.g. Mobile app)",
  "key.empty": "No keys created yet.",
  "key.onceWarning": "This key is shown ONLY NOW. Copy and store it safely — it cannot be shown again.",
  "key.howTo": "How to use it",
  "key.forget": "Remove from local list",
  "key.needAccount": "Sign in to create a key.",
  "key.failed": "The key could not be created. Please try again.",
  "key.revokeNote": "A key works until it expires. To revoke one early, change SYNCROM_API_SECRET on the server — that invalidates every key.",
  "libra.name": "Libra",
  "libra.sub": "Two different models answer independently, then get weighed",
  "libra.agreement": "Agreement",
  "libra.conflict": "Disagreement — look here",
  "libra.verdict": "Verdict",
  "libra.degraded": "The weighing failed; only one model answer is shown.",
  "libra.failed": "Libra could not get an answer. Please try again shortly.",
  "status.weighing": "Weighing two models...",
  "virgo.name": "Virgo",
  "virgo.hint": "Audit with Virgo — re-checks figures and facts",
  "virgo.checking": "Checking",
  "virgo.clean": "No issues found",
  "virgo.issues": "Issues found",
  "virgo.apply": "Apply the correction",
  "virgo.failed": "The audit failed. Please try again shortly.",
  "cap.title": "Capricorn",
  "cap.none": "No project",
  "cap.new": "New project",
  "cap.newName": "Untitled project",
  "cap.edit": "Edit project",
  "cap.sub": "The project goal, instructions and knowledge base are sent to the model with EVERY message in this project.",
  "cap.name": "Name",
  "cap.goal": "Goal",
  "cap.goalHint": "What are we working towards? One or two sentences.",
  "cap.instructions": "Instructions",
  "cap.instructionsHint": "How should the model behave here? E.g. keep answers short, use British spelling.",
  "cap.knowledge": "Knowledge base",
  "cap.knowledgeHint": "Fixed background: facts, terms, rules, extracts. The model trusts this over its general knowledge.",
  "cap.save": "Save",
  "cap.cancel": "Cancel",
  "cap.delete": "Delete project",
  "cap.deleteConfirm": "Are you sure? Click again",
  "cap.deleteNote": "Deleting a project does not delete its chats — they are simply detached.",
...
const ruCore = {
  ...
  "composer.hint": "Syncrom AI — на технологиях Groq и Puter",
  ...
  "about.techValue": "Groq (LLM), Puter (голос), Firebase (аккаунты)",
  "about.models": "Модели",
  "about.close": "Закрыть",

  "key.title": "API-ключи",
  "key.sub": "Создайте ключ, чтобы обращаться к Syncrom AI из своей программы.",
  "key.create": "Создать",
  "key.creating": "Создание...",
  "key.namePlaceholder": "Название ключа (напр. Мобильное приложение)",
  "key.empty": "Ключей пока нет.",
  "key.onceWarning": "Ключ показывается ТОЛЬКО СЕЙЧАС. Скопируйте и сохраните его — повторно он не отобразится.",
  "key.howTo": "Как использовать",
  "key.forget": "Убрать из локального списка",
  "key.needAccount": "Войдите в аккаунт, чтобы создать ключ.",
  "key.failed": "Не удалось создать ключ. Попробуйте снова.",
  "key.revokeNote": "Ключ действует до истечения срока. Чтобы отозвать досрочно, измените SYNCROM_API_SECRET на сервере — это аннулирует все ключи.",
  "libra.name": "Libra",
  "libra.sub": "Две разные модели отвечают независимо, затем их взвешивают",
  "libra.agreement": "Согласие",
  "libra.conflict": "Расхождение — обратите внимание",
  "libra.verdict": "Итог",
  "libra.degraded": "Взвешивание не удалось; показан ответ одной модели.",
  "libra.failed": "Libra не смогла получить ответ. Попробуйте позже.",
  "status.weighing": "Взвешиваю две модели...",
  "virgo.name": "Virgo",
  "virgo.hint": "Проверить через Virgo — перепроверяет цифры и факты",
  "virgo.checking": "Проверка",
  "virgo.clean": "Проблем не найдено",
  "virgo.issues": "Найдены проблемы",
  "virgo.apply": "Применить исправление",
  "virgo.failed": "Проверка не удалась. Попробуйте позже.",
  "cap.title": "Capricorn",
  "cap.none": "Без проекта",
  "cap.new": "Новый проект",
  "cap.newName": "Проект без названия",
  "cap.edit": "Редактировать проект",
  "cap.sub": "Цель, инструкции и база знаний проекта передаются модели с КАЖДЫМ сообщением в нём.",
  "cap.name": "Название",
  "cap.goal": "Цель",
  "cap.goalHint": "К чему идём? Одно-два предложения.",
  "cap.instructions": "Инструкции",
  "cap.instructionsHint": "Как модель должна вести себя здесь? Напр.: отвечать кратко.",
  "cap.knowledge": "База знаний",
  "cap.knowledgeHint": "Постоянный контекст: факты, термины, правила, выдержки. Модель доверяет этому больше, чем своим общим знаниям.",
  "cap.save": "Сохранить",
  "cap.cancel": "Отмена",
  "cap.delete": "Удалить проект",
  "cap.deleteConfirm": "Уверены? Нажмите снова",
  "cap.deleteNote": "Удаление проекта не удаляет его чаты — они просто отвязываются.",
...
const trCore = {
  ...
  "composer.hint": "Syncrom AI — Groq & Puter teknolojisiyle",
  ...
  "about.techValue": "Groq (LLM), Puter (ses), Firebase (hesap)",
  "about.models": "Modeller",
  "about.close": "Kapat",

  "key.title": "API anahtarları",
  "key.sub": "Syncrom AI'yı kendi yazılımından çağırmak için anahtar oluştur.",
  "key.create": "Oluştur",
  "key.creating": "Oluşturuluyor...",
  "key.namePlaceholder": "Anahtar adı (örn. Mobil uygulama)",
  "key.empty": "Henüz anahtar yok.",
  "key.onceWarning": "Bu anahtar SADECE ŞİMDİ gösteriliyor. Kopyala ve güvenle sakla — bir daha gösterilemez.",
  "key.howTo": "Nasıl kullanılır",
  "key.forget": "Yerel listeden kaldır",
  "key.needAccount": "Anahtar oluşturmak için giriş yap.",
  "key.failed": "Anahtar oluşturulamadı. Tekrar dene.",
  "key.revokeNote": "Anahtar süresi dolana kadar çalışır. Erken iptal için sunucudaki SYNCROM_API_SECRET değiştirilmelidir — bu tüm anahtarları geçersiz kılar.",
  "libra.name": "Libra",
  "libra.sub": "İki farklı model bağımsız yanıt verir, sonra tartılır",
  "libra.agreement": "Uzlaşma",
  "libra.conflict": "Ayrışma — buraya dikkat",
  "libra.verdict": "Sonuç",
  "libra.degraded": "Tartma başarısız; yalnızca bir modelin yanıtı gösteriliyor.",
  "libra.failed": "Libra yanıt alamadı. Birazdan tekrar dene.",
  "status.weighing": "İki model tartılıyor...",
  "virgo.name": "Virgo",
  "virgo.hint": "Virgo ile denetle — sayıları ve bilgileri yeniden doğrular",
  "virgo.checking": "Kontrol ediliyor",
  "virgo.clean": "Sorun bulunamadı",
  "virgo.issues": "Sorun bulundu",
  "virgo.apply": "Düzeltmeyi uygula",
  "virgo.failed": "Denetim başarısız. Birazdan tekrar dene.",
  "cap.title": "Capricorn",
  "cap.none": "Projesiz",
  "cap.new": "Yeni proje",
  "cap.newName": "Adsız proje",
  "cap.edit": "Projeyi düzenle",
  "cap.sub": "Projenin amacı, talimatı ve bilgi tabanı bu projedeki HER mesajda modele iletilir.",
  "cap.name": "Ad",
  "cap.goal": "Amaç",
  "cap.goalHint": "Neye çalışıyoruz? Bir iki cümle.",
  "cap.instructions": "Talimat",
  "cap.instructionsHint": "Model burada nasıl davransın? Örn. yanıtlar kısa olsun.",
  "cap.knowledge": "Bilgi tabanı",
  "cap.knowledgeHint": "Sabit arka plan: bilgiler, terimler, kurallar, alıntılar. Model buna genel bilgisinden çok güvenir.",
  "cap.save": "Kaydet",
  "cap.cancel": "İptal",
  "cap.delete": "Projeyi sil",
  "cap.deleteConfirm": "Emin misin? Tekrar bas",
  "cap.deleteNote": "Proje silindiğinde sohbetler silinmez — sadece projeden ayrılır.",
