export type SchalaView = "explorer" | "search" | "git" | "run" | "extensions" | "settings" | "account";
...
export default function SchalaActivityBar({ activeView, onChangeView, changeCount }: Props) {
  return (
    <nav className="schala-activitybar">
      <div className="schala-activitybar-top">
        ...
        <button 
          type="button" 
          className={`schala-activity-btn${activeView === "search" ? " active" : ""}`} 
          title="Search" 
        ...
        <button 
          type="button" 
          className={`schala-activity-btn${activeView === "run" ? " active" : ""}`} 
          title="Run & Debug" 
        ...
        <button 
          type="button" 
          className={`schala-activity-btn${activeView === "extensions" ? " active" : ""}`} 
          title="Extensions" 
      ...
      <div className="schala-activitybar-bottom">
        <button 
          type="button" 
          className={`schala-activity-btn${activeView === "settings" ? " active" : ""}`} 
          title="Settings" 
        ...
        <button 
          type="button" 
          className={`schala-activity-btn${activeView === "account" ? " active" : ""}`} 
          title="Account" 
